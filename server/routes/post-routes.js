...
routes.post('/user/create-post', ensureAuthenticated, restrictTo(['admin','user']),checkSchema(createPostSchema), postDataValidation, createPost)
...
routes.put('/user/user-posts/:_id', ensureAuthenticated, restrictTo(['admin','user']),checkSchema(updatePostSchema), postDataValidation, updateUserPost)

routes.patch('/user/posts/:id', ensureAuthenticated, restrictTo(['admin','user']), updatePostReaction)

routes.delete('/user/user-posts/:id', ensureAuthenticated, restrictTo(['admin','user']),checkSchema(deletePostSchema), postDataValidation, deleteUserPost)

routes.delete('/user/any-posts/:id', ensureAuthenticated, restrictTo(['admin']),checkSchema(deletePostSchema), postDataValidation, deleteAnyPost)
