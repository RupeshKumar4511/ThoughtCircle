...
export const signUp = createAsyncThunk('auth/signup', async (userData, thunkAPI) => {
    try {
        const response = await fetch('https://thoughtcircle.onrender.com/api/v1/users/signup', {
            method: "POST",
...
export const signIn = createAsyncThunk('auth/signin', async (userData,thunkAPI) => {
    try {
        const response = await fetch('https://thoughtcircle.onrender.com/api/v1/users/signin', {
            method: "POST",
            headers: { "Content-Type": 'application/json' },
            credentials: "include",
            body: JSON.stringify(userData)
...
export const signOut = createAsyncThunk('auth/signOut', async (userData,thunkAPI) => {
    try {
        const response = await fetch('https://thoughtcircle.onrender.com/api/v1/users/sign-out', {
            method: "POST",
            headers: { "Content-Type": 'application/json' },
            credentials: "include",
            body: JSON.stringify(userData)
...
export const sendMail = createAsyncThunk('auth/sendMail', async (userData,thunkAPI) => {
    try {
        const response = await fetch('https://thoughtcircle.onrender.com/api/v1/users/send-email', {
            method: "POST",
            headers: { "Content-Type": 'application/json' },
            body: JSON.stringify(userData)
        })
...
export const verifyEmail = createAsyncThunk('auth/verifyEmail', async (userData,thunkAPI) => {
    try {
        const response = await fetch('https://thoughtcircle.onrender.com/api/v1/users/verify-email', {
            method: "POST",
            headers: { "Content-Type": 'application/json' },
            body: JSON.stringify(userData)
        })
...
export const resetPassword = createAsyncThunk('auth/reset-password', async (userData,thunkAPI) => {
    try {
        const response = await fetch('https://thoughtcircle.onrender.com/api/v1/users/reset-password', {
            method: "POST",
            headers: { "Content-Type": 'application/json' },
            body: JSON.stringify(userData)
        })
